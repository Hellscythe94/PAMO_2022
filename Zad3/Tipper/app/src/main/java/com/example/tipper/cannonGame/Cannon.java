...
package com.example.tipper.cannonGame;
...
public class Cannon {
   ...
   private com.example.tipper.cannonGame.Cannonball cannonball; // the Cannon's Cannonball
   private Paint paint = new Paint(); // Paint used to draw the cannon
   private com.example.tipper.cannonGame.CannonView view; // view containing the Cannon

   // constructor
   public Cannon(com.example.tipper.cannonGame.CannonView view, int baseRadius, int barrelLength,
                 int barrelWidth) {
      this.view = view;
   ...
   public void fireCannonball() {
      ...
      int velocityX = (int) (com.example.tipper.cannonGame.CannonView.CANNONBALL_SPEED_PERCENT *
         view.getScreenWidth() * Math.sin(barrelAngle));

      // calculate the Cannonball velocity's y component
      int velocityY = (int) (com.example.tipper.cannonGame.CannonView.CANNONBALL_SPEED_PERCENT *
         view.getScreenWidth() * -Math.cos(barrelAngle));

      // calculate the Cannonball's radius
      int radius = (int) (view.getScreenHeight() *
         com.example.tipper.cannonGame.CannonView.CANNONBALL_RADIUS_PERCENT);

      // construct Cannonball and position it in the Cannon
      cannonball = new com.example.tipper.cannonGame.Cannonball(view, Color.BLACK,
         com.example.tipper.cannonGame.CannonView.CANNON_SOUND_ID, -radius,
   ...
   public com.example.tipper.cannonGame.Cannonball getCannonball() {
      return cannonball;
   }
