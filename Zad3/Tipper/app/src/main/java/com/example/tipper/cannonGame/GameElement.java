...
public class GameElement {
   protected com.example.tipper.cannonGame.CannonView view; // the view that contains this GameElement
   ...
   // public constructor
   public GameElement(com.example.tipper.cannonGame.CannonView view, int color, int soundId, int x,
