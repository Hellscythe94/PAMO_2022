...
public class CannonView extends SurfaceView
   ...
   private AppCompatActivity activity; // to display Game Over dialog in GUI thread
   ...
   private void showGameOverDialog(final int messageId) {
      ...
      final androidx.fragment.app.DialogFragment gameResult;
         //noinspection deprecati
         gameResult = new androidx.fragment.app.DialogFragment() {
