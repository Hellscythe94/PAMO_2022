...
public class CannonActivityFragment extends Fragment {
   private com.example.tipper.cannonGame.CannonView cannonView; // custom view to display the game
   ...
   public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      View view =
         inflater.inflate(R.layout.fragment_cannon, container, false);

      // get a reference to the CannonView
      cannonView = (com.example.tipper.cannonGame.CannonView) view.findViewById(R.id.cannonView);
      return view;
   }
