...
public class Cannonball extends com.example.tipper.cannonGame.GameElement {
   private float velocityX;
   private boolean onScreen;

   // constructor
   public Cannonball(com.example.tipper.cannonGame.CannonView view, int color, int soundId, int x,
   ...
   public boolean collidesWith(com.example.tipper.cannonGame.GameElement element) {
